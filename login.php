...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, username, password FROM users WHERE username LIKE ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            // The s in the binding statement denotes that we are using a string parameter and that php needs to inject quotes before and after the parameter
